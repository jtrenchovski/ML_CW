...
#     'C': [0.1, 1, 10],
#     'penalty': ['l2'],
#     'solver': ['saga', 'liblinear', 'sag', 'lbfgs'],
# }
param_grid = {
    'penalty': ['l2'],
    'solver': [],
...
# grid_search = GridSearchCV(estimator=log_reg2, param_grid=param_grid, cv=4, scoring='accuracy', verbose=1)
...
log_reg = LogisticRegression(max_iter= 10, solver='newton-cg', penalty='l2').fit(X_train, y_train)
