...
# max depth = 20, n-estimators = 10 gives 95% on test data - ADA
# max_leaf_nodes = 1000 and max_iter = 50 gives 95% as well 
...
hist = HistGradientBoostingClassifier(max_iter=100, max_leaf_nodes=100).fit(X_train, y_train)
