...
model = hmm.MultinomialHMM(n_components=n_hidd_states, n_symbols=3, n_iter=100, random_state=42)
...
model_known_trans = hmm.MultinomialHMM(
    n_components=n_hidd_states, n_iter=100, random_state=42, n_symbols=3,
