...
scaler = RobustScaler(quantile_range=(1, 99)).fit(X_pca)
...
kmeans = KMeans(K, init='random', n_init=10).fit(X_pca)
...
# above
gmm = GaussianMixture(n_components=K, n_init=10, covariance_type='tied').fit(X_pca)
