...
grid_search = GridSearchCV(estimator=log_reg2, param_grid=param_grid2, cv=4, scoring='accuracy', verbose=1)
...
log_reg = LogisticRegression(max_iter= 20, solver='newton-cholesky', penalty='l2').fit(X_train, y_train)
