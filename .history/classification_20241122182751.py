...
scaler_robust = RobustScaler().fit(X_final)
X_scaled_r = scaler_robust.transform(X_final)

X_train, x_test, y_train, y_test = train_test_split(X_scaled_r, yFull, test_size=0.2, random_state=42)
