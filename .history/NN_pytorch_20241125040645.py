...
data_train = np.loadtxt("regression_train.txt") ** 3
data_test = np.loadtxt("regression_test.txt") ** 3
...
train_loop(X_train_scaled, y_train, epochs, model, loss_fn, optimizer)
test_model(X_test_scaled, y_test, model, loss_fn)
