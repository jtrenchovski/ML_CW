...
grid_search = GridSearchCV(estimator=tree_model2, param_grid=param_grid, cv=4, scoring='accuracy', verbose=1)
grid_search.fit(X_train, y_train)

tree_model = DecisionTreeClassifier(criterion='').fit(X_train, y_train)
